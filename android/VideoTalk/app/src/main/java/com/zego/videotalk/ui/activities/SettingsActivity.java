...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void initCtrls() {
        ...
        TextView userIdView = (TextView) findViewById(R.id.tv_user_id);
        ...
        mResolutionView.setProgress(defaultLevel);
        ...
        mResolutionDescView.setText(getString(R.string.resolution_prefix, mResolutionText[defaultLevel]));
        ...
        mBitrateView.setProgress(ZegoAvConfig.VIDEO_BITRATES[defaultLevel]);
        mBitrateView.setOnSeekBarChangeListener(mSeekBarChangeListener);
        mBitrateDescView = (TextView) findViewById(R.id.tv_bitrate);
        mBitrateDescView.setText(getString(R.string.bitrate_prefix, ByteSizeUnit.toHumanString(ZegoAvConfig.VIDEO_BITRATES[defaultLevel], ByteSizeUnit.RADIX_TYPE.K, 2)) + "ps");

...
"color: #666666;"));
        ...
        m_edRoomID->setMinimumSize(QSize(0, 40));
...
" }"));
        ...
        m_bEnterRoom->setStyleSheet(QString::fromUtf8("QPushButton:!hover{\n"
"     font-family: \345\276\256\350\275\257\351\233\205\351\273\221;\n"
"     font-size: 16px;\n"
"	 border-radius: 2px;\n"
"     border: 1px solid #0e88eb;\n"
...
" }"));
    ...
    {
        ZegoMainDialog->setWindowTitle(QApplication::translate("ZegoMainDialog", "VideoTalk", Q_NULLPTR));
        label->setText(QApplication::translate("ZegoMainDialog", "VideoTalk (\345\233\275\345\206\205\347\211\210)", Q_NULLPTR));
        m_bJumpToNet->setText(QString());
        m_bMin->setText(QString());
        m_bClose->setText(QString());
        m_lbTitle->setText(QApplication::translate("ZegoMainDialog", "ZegoVideoTalk", Q_NULLPTR));
